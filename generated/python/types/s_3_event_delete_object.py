...
class S3EventDeleteObject(pydantic.BaseModel):
    version_id: typing.Optional[str] = pydantic.Field(alias="versionId")
    is_delete_marker: typing.Optional[bool] = pydantic.Field(alias="isDeleteMarker")
    object_key: str = pydantic.Field(alias="objectKey")
    bucket: str
    timestamp: dt.datetime
    provider: S3EventDeleteObjectProvider
