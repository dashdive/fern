...
class S3EventUploadPartCopy(pydantic.BaseModel):
    upload_id: str = pydantic.Field(alias="uploadId")
    bytes: int
    part_number: int = pydantic.Field(alias="partNumber")
    copy_source: S3EventUploadPartCopyCopySource = pydantic.Field(alias="copySource")
    bucket: str
    timestamp: dt.datetime
    provider: S3EventUploadPartCopyProvider
