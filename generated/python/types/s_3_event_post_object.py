...
class S3EventPostObject(pydantic.BaseModel):
    bytes: int
    version_id: typing.Optional[str] = pydantic.Field(alias="versionId")
    object_category: typing.Optional[str] = pydantic.Field(alias="objectCategory")
    file_type: typing.Optional[str] = pydantic.Field(alias="fileType")
    is_synthetic: typing.Optional[bool] = pydantic.Field(alias="isSynthetic")
    object_key: str = pydantic.Field(alias="objectKey")
    bucket: str
    timestamp: dt.datetime
    provider: S3EventPostObjectProvider
