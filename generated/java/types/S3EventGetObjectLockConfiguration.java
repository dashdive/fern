...
@JsonDeserialize(
    builder = S3EventGetObjectLockConfiguration.Builder.class
)
public final class S3EventGetObjectLockConfiguration {
  private final String bucket;

  private final OffsetDateTime timestamp;

  private final S3EventGetObjectLockConfigurationProvider provider;
  ...
  private S3EventGetObjectLockConfiguration(String bucket, OffsetDateTime timestamp,
      S3EventGetObjectLockConfigurationProvider provider, Optional<String> customerId,
  ...
  public S3EventGetObjectLockConfigurationProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventGetObjectLockConfiguration && equalTo((S3EventGetObjectLockConfiguration) other);
  }
  ...
  private boolean equalTo(S3EventGetObjectLockConfiguration other) {
  ...
  public interface BucketStage {
    ...
    Builder from(S3EventGetObjectLockConfiguration other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventGetObjectLockConfigurationProvider provider);
  }

  public interface _FinalStage {
    S3EventGetObjectLockConfiguration build();
  ...
  public static final class Builder implements BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventGetObjectLockConfigurationProvider provider;
    ...
    @Override
    public Builder from(S3EventGetObjectLockConfiguration other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventGetObjectLockConfigurationProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventGetObjectLockConfiguration build() {
      return new S3EventGetObjectLockConfiguration(bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
