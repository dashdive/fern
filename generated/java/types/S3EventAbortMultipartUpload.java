...
@JsonDeserialize(
    builder = S3EventAbortMultipartUpload.Builder.class
)
public final class S3EventAbortMultipartUpload {
  ...
  private final S3EventAbortMultipartUploadProvider provider;
  ...
  private S3EventAbortMultipartUpload(String uploadId, String bucket, OffsetDateTime timestamp,
      S3EventAbortMultipartUploadProvider provider, Optional<String> customerId,
  ...
  public S3EventAbortMultipartUploadProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventAbortMultipartUpload && equalTo((S3EventAbortMultipartUpload) other);
  }
  ...
  private boolean equalTo(S3EventAbortMultipartUpload other) {
    return uploadId.equals(other.uploadId) && bucket.equals(other.bucket) && timestamp.equals(other.timestamp) && provider.equals(other.provider) && customerId.equals(other.customerId) && featureId.equals(other.featureId) && clientType.equals(other.clientType) && clientId.equals(other.clientId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.uploadId, this.bucket, this.timestamp, this.provider, this.customerId, this.featureId, this.clientType, this.clientId);
  }
  ...
  public interface UploadIdStage {
    ...
    Builder from(S3EventAbortMultipartUpload other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventAbortMultipartUploadProvider provider);
  }

  public interface _FinalStage {
    S3EventAbortMultipartUpload build();
  ...
  public static final class Builder implements UploadIdStage, BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventAbortMultipartUploadProvider provider;
    ...
    @Override
    public Builder from(S3EventAbortMultipartUpload other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventAbortMultipartUploadProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventAbortMultipartUpload build() {
      return new S3EventAbortMultipartUpload(uploadId, bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
