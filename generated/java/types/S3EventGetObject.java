...
@JsonDeserialize(
    builder = S3EventGetObject.Builder.class
)
public final class S3EventGetObject {
  ...
  private final S3EventGetObjectProvider provider;
  ...
  private S3EventGetObject(int bytes, Optional<String> versionId, String objectKey, String bucket,
      OffsetDateTime timestamp, S3EventGetObjectProvider provider, Optional<String> customerId,
  ...
  public S3EventGetObjectProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventGetObject && equalTo((S3EventGetObject) other);
  }
  ...
  private boolean equalTo(S3EventGetObject other) {
    return bytes == other.bytes && versionId.equals(other.versionId) && objectKey.equals(other.objectKey) && bucket.equals(other.bucket) && timestamp.equals(other.timestamp) && provider.equals(other.provider) && customerId.equals(other.customerId) && featureId.equals(other.featureId) && clientType.equals(other.clientType) && clientId.equals(other.clientId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.bytes, this.versionId, this.objectKey, this.bucket, this.timestamp, this.provider, this.customerId, this.featureId, this.clientType, this.clientId);
  }
  ...
  public interface BytesStage {
    ...
    Builder from(S3EventGetObject other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventGetObjectProvider provider);
  }

  public interface _FinalStage {
    S3EventGetObject build();
  ...
  public static final class Builder implements BytesStage, ObjectKeyStage, BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventGetObjectProvider provider;
    ...
    @Override
    public Builder from(S3EventGetObject other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventGetObjectProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventGetObject build() {
      return new S3EventGetObject(bytes, versionId, objectKey, bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
