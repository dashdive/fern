...
@JsonDeserialize(
    builder = S3EventHeadBucket.Builder.class
)
public final class S3EventHeadBucket {
  private final String bucket;

  private final OffsetDateTime timestamp;

  private final S3EventHeadBucketProvider provider;
  ...
  private S3EventHeadBucket(String bucket, OffsetDateTime timestamp,
      S3EventHeadBucketProvider provider, Optional<String> customerId, Optional<String> featureId,
  ...
  public S3EventHeadBucketProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventHeadBucket && equalTo((S3EventHeadBucket) other);
  }
  ...
  private boolean equalTo(S3EventHeadBucket other) {
  ...
  public interface BucketStage {
    ...
    Builder from(S3EventHeadBucket other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventHeadBucketProvider provider);
  }

  public interface _FinalStage {
    S3EventHeadBucket build();
  ...
  public static final class Builder implements BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventHeadBucketProvider provider;
    ...
    @Override
    public Builder from(S3EventHeadBucket other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventHeadBucketProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventHeadBucket build() {
      return new S3EventHeadBucket(bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
