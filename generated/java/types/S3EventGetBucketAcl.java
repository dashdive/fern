...
@JsonDeserialize(
    builder = S3EventGetBucketAcl.Builder.class
)
public final class S3EventGetBucketAcl {
  private final String bucket;

  private final OffsetDateTime timestamp;

  private final S3EventGetBucketAclProvider provider;
  ...
  private S3EventGetBucketAcl(String bucket, OffsetDateTime timestamp,
      S3EventGetBucketAclProvider provider, Optional<String> customerId, Optional<String> featureId,
  ...
  public S3EventGetBucketAclProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventGetBucketAcl && equalTo((S3EventGetBucketAcl) other);
  }
  ...
  private boolean equalTo(S3EventGetBucketAcl other) {
  ...
  public interface BucketStage {
    ...
    Builder from(S3EventGetBucketAcl other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventGetBucketAclProvider provider);
  }

  public interface _FinalStage {
    S3EventGetBucketAcl build();
  ...
  public static final class Builder implements BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventGetBucketAclProvider provider;
    ...
    @Override
    public Builder from(S3EventGetBucketAcl other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventGetBucketAclProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventGetBucketAcl build() {
      return new S3EventGetBucketAcl(bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
