...
@JsonDeserialize(
    builder = S3EventCopyObjectCopySource.Builder.class
)
public final class S3EventCopyObjectCopySource {
  ...
  private S3EventCopyObjectCopySource(String bucket, String objectKey, Optional<String> versionId,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventCopyObjectCopySource && equalTo((S3EventCopyObjectCopySource) other);
  }
  ...
  private boolean equalTo(S3EventCopyObjectCopySource other) {
  ...
  public interface BucketStage {
    ...
    Builder from(S3EventCopyObjectCopySource other);
  }
  ...
  public interface _FinalStage {
    S3EventCopyObjectCopySource build();
  ...
  public static final class Builder implements BucketStage, ObjectKeyStage, _FinalStage {
    ...
    @Override
    public Builder from(S3EventCopyObjectCopySource other) {
    ...
    @Override
    public S3EventCopyObjectCopySource build() {
      return new S3EventCopyObjectCopySource(bucket, objectKey, versionId, additionalProperties);
    }
  }
}
