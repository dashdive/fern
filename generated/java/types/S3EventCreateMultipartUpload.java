...
@JsonDeserialize(
    builder = S3EventCreateMultipartUpload.Builder.class
)
public final class S3EventCreateMultipartUpload {
  ...
  private final S3EventCreateMultipartUploadProvider provider;
  ...
  private S3EventCreateMultipartUpload(String uploadId, String objectKey, String bucket,
      OffsetDateTime timestamp, S3EventCreateMultipartUploadProvider provider,
  ...
  public S3EventCreateMultipartUploadProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventCreateMultipartUpload && equalTo((S3EventCreateMultipartUpload) other);
  }
  ...
  private boolean equalTo(S3EventCreateMultipartUpload other) {
    return uploadId.equals(other.uploadId) && objectKey.equals(other.objectKey) && bucket.equals(other.bucket) && timestamp.equals(other.timestamp) && provider.equals(other.provider) && customerId.equals(other.customerId) && featureId.equals(other.featureId) && clientType.equals(other.clientType) && clientId.equals(other.clientId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.uploadId, this.objectKey, this.bucket, this.timestamp, this.provider, this.customerId, this.featureId, this.clientType, this.clientId);
  }
  ...
  public interface UploadIdStage {
    ObjectKeyStage uploadId(String uploadId);

    Builder from(S3EventCreateMultipartUpload other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventCreateMultipartUploadProvider provider);
  }

  public interface _FinalStage {
    S3EventCreateMultipartUpload build();
  ...
  public static final class Builder implements UploadIdStage, ObjectKeyStage, BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventCreateMultipartUploadProvider provider;
    ...
    @Override
    public Builder from(S3EventCreateMultipartUpload other) {
    ...
    @Override
    @JsonSetter("uploadId")
    public ObjectKeyStage uploadId(String uploadId) {
      this.uploadId = uploadId;
      return this;
    }
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventCreateMultipartUploadProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventCreateMultipartUpload build() {
      return new S3EventCreateMultipartUpload(uploadId, objectKey, bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
