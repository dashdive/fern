...
@JsonDeserialize(
    builder = S3EventGetBucketCors.Builder.class
)
public final class S3EventGetBucketCors {
  private final String bucket;

  private final OffsetDateTime timestamp;

  private final S3EventGetBucketCorsProvider provider;
  ...
  private S3EventGetBucketCors(String bucket, OffsetDateTime timestamp,
      S3EventGetBucketCorsProvider provider, Optional<String> customerId,
  ...
  public S3EventGetBucketCorsProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventGetBucketCors && equalTo((S3EventGetBucketCors) other);
  }
  ...
  private boolean equalTo(S3EventGetBucketCors other) {
  ...
  public interface BucketStage {
    ...
    Builder from(S3EventGetBucketCors other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventGetBucketCorsProvider provider);
  }

  public interface _FinalStage {
    S3EventGetBucketCors build();
  ...
  public static final class Builder implements BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventGetBucketCorsProvider provider;
    ...
    @Override
    public Builder from(S3EventGetBucketCors other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventGetBucketCorsProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventGetBucketCors build() {
      return new S3EventGetBucketCors(bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
