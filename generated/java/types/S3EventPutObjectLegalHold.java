...
@JsonDeserialize(
    builder = S3EventPutObjectLegalHold.Builder.class
)
public final class S3EventPutObjectLegalHold {
  ...
  private final S3EventPutObjectLegalHoldProvider provider;
  ...
  private S3EventPutObjectLegalHold(String objectKey, String bucket, OffsetDateTime timestamp,
      S3EventPutObjectLegalHoldProvider provider, Optional<String> customerId,
  ...
  public S3EventPutObjectLegalHoldProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventPutObjectLegalHold && equalTo((S3EventPutObjectLegalHold) other);
  }
  ...
  private boolean equalTo(S3EventPutObjectLegalHold other) {
  ...
  public interface ObjectKeyStage {
    ...
    Builder from(S3EventPutObjectLegalHold other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventPutObjectLegalHoldProvider provider);
  }

  public interface _FinalStage {
    S3EventPutObjectLegalHold build();
  ...
  public static final class Builder implements ObjectKeyStage, BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventPutObjectLegalHoldProvider provider;
    ...
    @Override
    public Builder from(S3EventPutObjectLegalHold other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventPutObjectLegalHoldProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventPutObjectLegalHold build() {
      return new S3EventPutObjectLegalHold(objectKey, bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
