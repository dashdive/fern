...
@JsonDeserialize(
    builder = S3EventListParts.Builder.class
)
public final class S3EventListParts {
  ...
  private final S3EventListPartsProvider provider;
  ...
  private S3EventListParts(String uploadId, String bucket, OffsetDateTime timestamp,
      S3EventListPartsProvider provider, Optional<String> customerId, Optional<String> featureId,
  ...
  public S3EventListPartsProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventListParts && equalTo((S3EventListParts) other);
  }
  ...
  private boolean equalTo(S3EventListParts other) {
  ...
  public interface UploadIdStage {
    ...
    Builder from(S3EventListParts other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventListPartsProvider provider);
  }

  public interface _FinalStage {
    S3EventListParts build();
  ...
  public static final class Builder implements UploadIdStage, BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventListPartsProvider provider;
    ...
    @Override
    public Builder from(S3EventListParts other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventListPartsProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventListParts build() {
      return new S3EventListParts(uploadId, bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
