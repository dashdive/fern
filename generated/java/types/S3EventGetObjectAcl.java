...
@JsonDeserialize(
    builder = S3EventGetObjectAcl.Builder.class
)
public final class S3EventGetObjectAcl {
  ...
  private final S3EventGetObjectAclProvider provider;
  ...
  private S3EventGetObjectAcl(String objectKey, String bucket, OffsetDateTime timestamp,
      S3EventGetObjectAclProvider provider, Optional<String> customerId, Optional<String> featureId,
  ...
  public S3EventGetObjectAclProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventGetObjectAcl && equalTo((S3EventGetObjectAcl) other);
  }
  ...
  private boolean equalTo(S3EventGetObjectAcl other) {
  ...
  public interface ObjectKeyStage {
    ...
    Builder from(S3EventGetObjectAcl other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventGetObjectAclProvider provider);
  }

  public interface _FinalStage {
    S3EventGetObjectAcl build();
  ...
  public static final class Builder implements ObjectKeyStage, BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventGetObjectAclProvider provider;
    ...
    @Override
    public Builder from(S3EventGetObjectAcl other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventGetObjectAclProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventGetObjectAcl build() {
      return new S3EventGetObjectAcl(objectKey, bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
