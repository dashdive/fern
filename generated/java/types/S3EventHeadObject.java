...
@JsonDeserialize(
    builder = S3EventHeadObject.Builder.class
)
public final class S3EventHeadObject {
  ...
  private final S3EventHeadObjectProvider provider;
  ...
  private S3EventHeadObject(String objectKey, String bucket, OffsetDateTime timestamp,
      S3EventHeadObjectProvider provider, Optional<String> customerId, Optional<String> featureId,
  ...
  public S3EventHeadObjectProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventHeadObject && equalTo((S3EventHeadObject) other);
  }
  ...
  private boolean equalTo(S3EventHeadObject other) {
  ...
  public interface ObjectKeyStage {
    ...
    Builder from(S3EventHeadObject other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventHeadObjectProvider provider);
  }

  public interface _FinalStage {
    S3EventHeadObject build();
  ...
  public static final class Builder implements ObjectKeyStage, BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventHeadObjectProvider provider;
    ...
    @Override
    public Builder from(S3EventHeadObject other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventHeadObjectProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventHeadObject build() {
      return new S3EventHeadObject(objectKey, bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
