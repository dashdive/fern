...
@JsonDeserialize(
    builder = S3EventPutObjectRetention.Builder.class
)
public final class S3EventPutObjectRetention {
  ...
  private final S3EventPutObjectRetentionProvider provider;
  ...
  private S3EventPutObjectRetention(String objectKey, String bucket, OffsetDateTime timestamp,
      S3EventPutObjectRetentionProvider provider, Optional<String> customerId,
  ...
  public S3EventPutObjectRetentionProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventPutObjectRetention && equalTo((S3EventPutObjectRetention) other);
  }
  ...
  private boolean equalTo(S3EventPutObjectRetention other) {
  ...
  public interface ObjectKeyStage {
    ...
    Builder from(S3EventPutObjectRetention other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventPutObjectRetentionProvider provider);
  }

  public interface _FinalStage {
    S3EventPutObjectRetention build();
  ...
  public static final class Builder implements ObjectKeyStage, BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventPutObjectRetentionProvider provider;
    ...
    @Override
    public Builder from(S3EventPutObjectRetention other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventPutObjectRetentionProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventPutObjectRetention build() {
      return new S3EventPutObjectRetention(objectKey, bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
