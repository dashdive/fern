...
@JsonDeserialize(
    builder = S3EventListObjectsV2.Builder.class
)
public final class S3EventListObjectsV2 {
  private final String bucket;

  private final OffsetDateTime timestamp;

  private final S3EventListObjectsV2Provider provider;
  ...
  private S3EventListObjectsV2(String bucket, OffsetDateTime timestamp,
      S3EventListObjectsV2Provider provider, Optional<String> customerId,
  ...
  public S3EventListObjectsV2Provider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventListObjectsV2 && equalTo((S3EventListObjectsV2) other);
  }
  ...
  private boolean equalTo(S3EventListObjectsV2 other) {
  ...
  public interface BucketStage {
    ...
    Builder from(S3EventListObjectsV2 other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventListObjectsV2Provider provider);
  }

  public interface _FinalStage {
    S3EventListObjectsV2 build();
  ...
  public static final class Builder implements BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventListObjectsV2Provider provider;
    ...
    @Override
    public Builder from(S3EventListObjectsV2 other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventListObjectsV2Provider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventListObjectsV2 build() {
      return new S3EventListObjectsV2(bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
