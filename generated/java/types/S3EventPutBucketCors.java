...
@JsonDeserialize(
    builder = S3EventPutBucketCors.Builder.class
)
public final class S3EventPutBucketCors {
  private final String bucket;

  private final OffsetDateTime timestamp;

  private final S3EventPutBucketCorsProvider provider;
  ...
  private S3EventPutBucketCors(String bucket, OffsetDateTime timestamp,
      S3EventPutBucketCorsProvider provider, Optional<String> customerId,
  ...
  public S3EventPutBucketCorsProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventPutBucketCors && equalTo((S3EventPutBucketCors) other);
  }
  ...
  private boolean equalTo(S3EventPutBucketCors other) {
  ...
  public interface BucketStage {
    ...
    Builder from(S3EventPutBucketCors other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventPutBucketCorsProvider provider);
  }

  public interface _FinalStage {
    S3EventPutBucketCors build();
  ...
  public static final class Builder implements BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventPutBucketCorsProvider provider;
    ...
    @Override
    public Builder from(S3EventPutBucketCors other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventPutBucketCorsProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventPutBucketCors build() {
      return new S3EventPutBucketCors(bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
