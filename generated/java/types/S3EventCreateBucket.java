...
@JsonDeserialize(
    builder = S3EventCreateBucket.Builder.class
)
public final class S3EventCreateBucket {
  private final String bucket;

  private final OffsetDateTime timestamp;

  private final S3EventCreateBucketProvider provider;
  ...
  private S3EventCreateBucket(String bucket, OffsetDateTime timestamp,
      S3EventCreateBucketProvider provider, Optional<String> customerId, Optional<String> featureId,
  ...
  public S3EventCreateBucketProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventCreateBucket && equalTo((S3EventCreateBucket) other);
  }
  ...
  private boolean equalTo(S3EventCreateBucket other) {
  ...
  public interface BucketStage {
    ...
    Builder from(S3EventCreateBucket other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventCreateBucketProvider provider);
  }

  public interface _FinalStage {
    S3EventCreateBucket build();
  ...
  public static final class Builder implements BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventCreateBucketProvider provider;
    ...
    @Override
    public Builder from(S3EventCreateBucket other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventCreateBucketProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventCreateBucket build() {
      return new S3EventCreateBucket(bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
