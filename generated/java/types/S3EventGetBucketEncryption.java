...
@JsonDeserialize(
    builder = S3EventGetBucketEncryption.Builder.class
)
public final class S3EventGetBucketEncryption {
  private final String bucket;

  private final OffsetDateTime timestamp;

  private final S3EventGetBucketEncryptionProvider provider;
  ...
  private S3EventGetBucketEncryption(String bucket, OffsetDateTime timestamp,
      S3EventGetBucketEncryptionProvider provider, Optional<String> customerId,
  ...
  public S3EventGetBucketEncryptionProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventGetBucketEncryption && equalTo((S3EventGetBucketEncryption) other);
  }
  ...
  private boolean equalTo(S3EventGetBucketEncryption other) {
  ...
  public interface BucketStage {
    ...
    Builder from(S3EventGetBucketEncryption other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventGetBucketEncryptionProvider provider);
  }

  public interface _FinalStage {
    S3EventGetBucketEncryption build();
  ...
  public static final class Builder implements BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventGetBucketEncryptionProvider provider;
    ...
    @Override
    public Builder from(S3EventGetBucketEncryption other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventGetBucketEncryptionProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventGetBucketEncryption build() {
      return new S3EventGetBucketEncryption(bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
