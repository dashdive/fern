...
@JsonDeserialize(
    builder = S3EventListObjectVersions.Builder.class
)
public final class S3EventListObjectVersions {
  ...
  private final S3EventListObjectVersionsProvider provider;
  ...
  private S3EventListObjectVersions(String objectKey, String bucket, OffsetDateTime timestamp,
      S3EventListObjectVersionsProvider provider, Optional<String> customerId,
  ...
  public S3EventListObjectVersionsProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventListObjectVersions && equalTo((S3EventListObjectVersions) other);
  }
  ...
  private boolean equalTo(S3EventListObjectVersions other) {
  ...
  public interface ObjectKeyStage {
    ...
    Builder from(S3EventListObjectVersions other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventListObjectVersionsProvider provider);
  }

  public interface _FinalStage {
    S3EventListObjectVersions build();
  ...
  public static final class Builder implements ObjectKeyStage, BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventListObjectVersionsProvider provider;
    ...
    @Override
    public Builder from(S3EventListObjectVersions other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventListObjectVersionsProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventListObjectVersions build() {
      return new S3EventListObjectVersions(objectKey, bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
