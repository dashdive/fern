...
@JsonDeserialize(
    builder = S3EventDeleteBucketCors.Builder.class
)
public final class S3EventDeleteBucketCors {
  private final String bucket;

  private final OffsetDateTime timestamp;

  private final S3EventDeleteBucketCorsProvider provider;
  ...
  private S3EventDeleteBucketCors(String bucket, OffsetDateTime timestamp,
      S3EventDeleteBucketCorsProvider provider, Optional<String> customerId,
  ...
  public S3EventDeleteBucketCorsProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventDeleteBucketCors && equalTo((S3EventDeleteBucketCors) other);
  }
  ...
  private boolean equalTo(S3EventDeleteBucketCors other) {
  ...
  public interface BucketStage {
    ...
    Builder from(S3EventDeleteBucketCors other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventDeleteBucketCorsProvider provider);
  }

  public interface _FinalStage {
    S3EventDeleteBucketCors build();
  ...
  public static final class Builder implements BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventDeleteBucketCorsProvider provider;
    ...
    @Override
    public Builder from(S3EventDeleteBucketCors other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventDeleteBucketCorsProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventDeleteBucketCors build() {
      return new S3EventDeleteBucketCors(bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
