...
@JsonDeserialize(
    builder = S3EventGetObjectRetention.Builder.class
)
public final class S3EventGetObjectRetention {
  ...
  private final S3EventGetObjectRetentionProvider provider;
  ...
  private S3EventGetObjectRetention(String objectKey, String bucket, OffsetDateTime timestamp,
      S3EventGetObjectRetentionProvider provider, Optional<String> customerId,
  ...
  public S3EventGetObjectRetentionProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventGetObjectRetention && equalTo((S3EventGetObjectRetention) other);
  }
  ...
  private boolean equalTo(S3EventGetObjectRetention other) {
  ...
  public interface ObjectKeyStage {
    ...
    Builder from(S3EventGetObjectRetention other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventGetObjectRetentionProvider provider);
  }

  public interface _FinalStage {
    S3EventGetObjectRetention build();
  ...
  public static final class Builder implements ObjectKeyStage, BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventGetObjectRetentionProvider provider;
    ...
    @Override
    public Builder from(S3EventGetObjectRetention other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventGetObjectRetentionProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventGetObjectRetention build() {
      return new S3EventGetObjectRetention(objectKey, bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
