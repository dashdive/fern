...
@JsonDeserialize(
    builder = S3EventDeleteBucketEncryption.Builder.class
)
public final class S3EventDeleteBucketEncryption {
  private final String bucket;

  private final OffsetDateTime timestamp;

  private final S3EventDeleteBucketEncryptionProvider provider;
  ...
  private S3EventDeleteBucketEncryption(String bucket, OffsetDateTime timestamp,
      S3EventDeleteBucketEncryptionProvider provider, Optional<String> customerId,
  ...
  public S3EventDeleteBucketEncryptionProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventDeleteBucketEncryption && equalTo((S3EventDeleteBucketEncryption) other);
  }
  ...
  private boolean equalTo(S3EventDeleteBucketEncryption other) {
  ...
  public interface BucketStage {
    ...
    Builder from(S3EventDeleteBucketEncryption other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventDeleteBucketEncryptionProvider provider);
  }

  public interface _FinalStage {
    S3EventDeleteBucketEncryption build();
  ...
  public static final class Builder implements BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventDeleteBucketEncryptionProvider provider;
    ...
    @Override
    public Builder from(S3EventDeleteBucketEncryption other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventDeleteBucketEncryptionProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventDeleteBucketEncryption build() {
      return new S3EventDeleteBucketEncryption(bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
