...
@JsonDeserialize(
    builder = S3EventDeleteBucket.Builder.class
)
public final class S3EventDeleteBucket {
  ...
  private final S3EventDeleteBucketProvider provider;
  ...
  private S3EventDeleteBucket(Optional<Boolean> force, String bucket, OffsetDateTime timestamp,
      S3EventDeleteBucketProvider provider, Optional<String> customerId, Optional<String> featureId,
  ...
  public S3EventDeleteBucketProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventDeleteBucket && equalTo((S3EventDeleteBucket) other);
  }
  ...
  private boolean equalTo(S3EventDeleteBucket other) {
    return force.equals(other.force) && bucket.equals(other.bucket) && timestamp.equals(other.timestamp) && provider.equals(other.provider) && customerId.equals(other.customerId) && featureId.equals(other.featureId) && clientType.equals(other.clientType) && clientId.equals(other.clientId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.force, this.bucket, this.timestamp, this.provider, this.customerId, this.featureId, this.clientType, this.clientId);
  }
  ...
  public interface BucketStage {
    ...
    Builder from(S3EventDeleteBucket other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventDeleteBucketProvider provider);
  }

  public interface _FinalStage {
    S3EventDeleteBucket build();
  ...
  public static final class Builder implements BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventDeleteBucketProvider provider;
    ...
    @Override
    public Builder from(S3EventDeleteBucket other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventDeleteBucketProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventDeleteBucket build() {
      return new S3EventDeleteBucket(force, bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
