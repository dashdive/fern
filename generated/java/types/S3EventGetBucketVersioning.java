...
@JsonDeserialize(
    builder = S3EventGetBucketVersioning.Builder.class
)
public final class S3EventGetBucketVersioning {
  private final String bucket;

  private final OffsetDateTime timestamp;

  private final S3EventGetBucketVersioningProvider provider;
  ...
  private S3EventGetBucketVersioning(String bucket, OffsetDateTime timestamp,
      S3EventGetBucketVersioningProvider provider, Optional<String> customerId,
  ...
  public S3EventGetBucketVersioningProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventGetBucketVersioning && equalTo((S3EventGetBucketVersioning) other);
  }
  ...
  private boolean equalTo(S3EventGetBucketVersioning other) {
  ...
  public interface BucketStage {
    ...
    Builder from(S3EventGetBucketVersioning other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventGetBucketVersioningProvider provider);
  }

  public interface _FinalStage {
    S3EventGetBucketVersioning build();
  ...
  public static final class Builder implements BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventGetBucketVersioningProvider provider;
    ...
    @Override
    public Builder from(S3EventGetBucketVersioning other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventGetBucketVersioningProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventGetBucketVersioning build() {
      return new S3EventGetBucketVersioning(bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
