...
@JsonDeserialize(
    builder = S3EventPutBucketEncryption.Builder.class
)
public final class S3EventPutBucketEncryption {
  private final String bucket;

  private final OffsetDateTime timestamp;

  private final S3EventPutBucketEncryptionProvider provider;
  ...
  private S3EventPutBucketEncryption(String bucket, OffsetDateTime timestamp,
      S3EventPutBucketEncryptionProvider provider, Optional<String> customerId,
  ...
  public S3EventPutBucketEncryptionProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventPutBucketEncryption && equalTo((S3EventPutBucketEncryption) other);
  }
  ...
  private boolean equalTo(S3EventPutBucketEncryption other) {
  ...
  public interface BucketStage {
    ...
    Builder from(S3EventPutBucketEncryption other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventPutBucketEncryptionProvider provider);
  }

  public interface _FinalStage {
    S3EventPutBucketEncryption build();
  ...
  public static final class Builder implements BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventPutBucketEncryptionProvider provider;
    ...
    @Override
    public Builder from(S3EventPutBucketEncryption other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventPutBucketEncryptionProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventPutBucketEncryption build() {
      return new S3EventPutBucketEncryption(bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
