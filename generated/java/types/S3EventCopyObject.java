...
@JsonDeserialize(
    builder = S3EventCopyObject.Builder.class
)
public final class S3EventCopyObject {
  private final Optional<String> versionId;

  private final S3EventCopyObjectCopySource copySource;
  ...
  private final S3EventCopyObjectProvider provider;
  ...
  private S3EventCopyObject(Optional<String> versionId, S3EventCopyObjectCopySource copySource,
      String objectKey, String bucket, OffsetDateTime timestamp, S3EventCopyObjectProvider provider,
  ...
  public S3EventCopyObjectCopySource getCopySource() {
    return copySource;
  }
  ...
  public S3EventCopyObjectProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventCopyObject && equalTo((S3EventCopyObject) other);
  }
  ...
  private boolean equalTo(S3EventCopyObject other) {
    return versionId.equals(other.versionId) && copySource.equals(other.copySource) && objectKey.equals(other.objectKey) && bucket.equals(other.bucket) && timestamp.equals(other.timestamp) && provider.equals(other.provider) && customerId.equals(other.customerId) && featureId.equals(other.featureId) && clientType.equals(other.clientType) && clientId.equals(other.clientId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.versionId, this.copySource, this.objectKey, this.bucket, this.timestamp, this.provider, this.customerId, this.featureId, this.clientType, this.clientId);
  }
  ...
  public static CopySourceStage builder() {
    return new Builder();
  }

  public interface CopySourceStage {
    ObjectKeyStage copySource(S3EventCopyObjectCopySource copySource);

    Builder from(S3EventCopyObject other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventCopyObjectProvider provider);
  }

  public interface _FinalStage {
    S3EventCopyObject build();
  ...
  public static final class Builder implements CopySourceStage, ObjectKeyStage, BucketStage, TimestampStage, ProviderStage, _FinalStage {
    private S3EventCopyObjectCopySource copySource;
    ...
    private S3EventCopyObjectProvider provider;
    ...
    @Override
    public Builder from(S3EventCopyObject other) {
    ...
    public ObjectKeyStage copySource(S3EventCopyObjectCopySource copySource) {
      this.copySource = copySource;
      return this;
    }
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventCopyObjectProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventCopyObject build() {
      return new S3EventCopyObject(versionId, copySource, objectKey, bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
