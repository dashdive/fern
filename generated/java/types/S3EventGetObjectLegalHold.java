...
@JsonDeserialize(
    builder = S3EventGetObjectLegalHold.Builder.class
)
public final class S3EventGetObjectLegalHold {
  ...
  private final S3EventGetObjectLegalHoldProvider provider;
  ...
  private S3EventGetObjectLegalHold(String objectKey, String bucket, OffsetDateTime timestamp,
      S3EventGetObjectLegalHoldProvider provider, Optional<String> customerId,
  ...
  public S3EventGetObjectLegalHoldProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventGetObjectLegalHold && equalTo((S3EventGetObjectLegalHold) other);
  }
  ...
  private boolean equalTo(S3EventGetObjectLegalHold other) {
  ...
  public interface ObjectKeyStage {
    ...
    Builder from(S3EventGetObjectLegalHold other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventGetObjectLegalHoldProvider provider);
  }

  public interface _FinalStage {
    S3EventGetObjectLegalHold build();
  ...
  public static final class Builder implements ObjectKeyStage, BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventGetObjectLegalHoldProvider provider;
    ...
    @Override
    public Builder from(S3EventGetObjectLegalHold other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventGetObjectLegalHoldProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventGetObjectLegalHold build() {
      return new S3EventGetObjectLegalHold(objectKey, bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
