...
@JsonDeserialize(
    builder = S3EventPutBucketAcl.Builder.class
)
public final class S3EventPutBucketAcl {
  private final String bucket;

  private final OffsetDateTime timestamp;

  private final S3EventPutBucketAclProvider provider;
  ...
  private S3EventPutBucketAcl(String bucket, OffsetDateTime timestamp,
      S3EventPutBucketAclProvider provider, Optional<String> customerId, Optional<String> featureId,
  ...
  public S3EventPutBucketAclProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventPutBucketAcl && equalTo((S3EventPutBucketAcl) other);
  }
  ...
  private boolean equalTo(S3EventPutBucketAcl other) {
  ...
  public interface BucketStage {
    ...
    Builder from(S3EventPutBucketAcl other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventPutBucketAclProvider provider);
  }

  public interface _FinalStage {
    S3EventPutBucketAcl build();
  ...
  public static final class Builder implements BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventPutBucketAclProvider provider;
    ...
    @Override
    public Builder from(S3EventPutBucketAcl other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventPutBucketAclProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventPutBucketAcl build() {
      return new S3EventPutBucketAcl(bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
