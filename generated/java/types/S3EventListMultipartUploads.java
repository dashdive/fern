...
@JsonDeserialize(
    builder = S3EventListMultipartUploads.Builder.class
)
public final class S3EventListMultipartUploads {
  private final String bucket;

  private final OffsetDateTime timestamp;

  private final S3EventListMultipartUploadsProvider provider;
  ...
  private S3EventListMultipartUploads(String bucket, OffsetDateTime timestamp,
      S3EventListMultipartUploadsProvider provider, Optional<String> customerId,
  ...
  public S3EventListMultipartUploadsProvider getProvider() {
    return provider;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof S3EventListMultipartUploads && equalTo((S3EventListMultipartUploads) other);
  }
  ...
  private boolean equalTo(S3EventListMultipartUploads other) {
  ...
  public interface BucketStage {
    ...
    Builder from(S3EventListMultipartUploads other);
  }
  ...
  public interface ProviderStage {
    _FinalStage provider(S3EventListMultipartUploadsProvider provider);
  }

  public interface _FinalStage {
    S3EventListMultipartUploads build();
  ...
  public static final class Builder implements BucketStage, TimestampStage, ProviderStage, _FinalStage {
    ...
    private S3EventListMultipartUploadsProvider provider;
    ...
    @Override
    public Builder from(S3EventListMultipartUploads other) {
    ...
    @Override
    @JsonSetter("provider")
    public _FinalStage provider(S3EventListMultipartUploadsProvider provider) {
      this.provider = provider;
      return this;
    }
    ...
    @Override
    public S3EventListMultipartUploads build() {
      return new S3EventListMultipartUploads(bucket, timestamp, provider, customerId, featureId, clientType, clientId, additionalProperties);
    }
  }
}
